...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_images.count >= indexPath.row + 1) {
        ...
        }else if ([_images[indexPath.row] isKindOfClass:[NSDictionary class]]){
            NSDictionary *imgDict = _images[indexPath.row];
            cell.imageView.image = [RCTConvert UIImage:imgDict];
        }else {
